...
public class TestBanking {
  ...
  public static void main(String[] args) {
    ...
    {
      customer = bank.getCustomer(cust_idx);//循环内用于获得银行内的每个客户
      ...
      {
    	  Account account = customer.getAccount(acct_idx);//循环内部使用的引用，用于获得用户的不同账户
    	  String  account_type = "";
	...
	***/
    	  if(account instanceof SavingsAccount)//类比较函数的使用
    	  {
